...
(function () {
  ...
  // --- SIKKER UI (ingen innerHTML og ingen decimale CSS-shorthands) ---
  function injectUI(){
    ...
    // row: Besked
    const rowMsg=document.createElement('div'); rowMsg.style.display='flex';
    rowMsg.style.alignItems='center'; rowMsg.style.gap='6px'; rowMsg.style.margin='2px 0';
    const lblMsg=document.createElement('label'); lblMsg.style.display='flex';
    lblMsg.style.gap='6px'; lblMsg.style.alignItems='center'; lblMsg.style.minWidth='0';
    ...
    // row: Interesse
    const rowInt=document.createElement('div'); rowInt.style.display='flex';
    rowInt.style.alignItems='center'; rowInt.style.gap='6px'; rowInt.style.margin='2px 0 6px 0';
    const lblInt=document.createElement('label'); lblInt.style.display='flex';
    lblInt.style.gap='6px'; lblInt.style.alignItems='center'; lblInt.style.minWidth='0';
    ...
    // SMS
    const sms=document.createElement('div'); sms.id='tpSMS';
    sms.style.borderTop='1px solid #eeeeee'; sms.style.marginTop='6px'; sms.style.paddingTop='6px';
    const smsStatus=document.createElement('div'); smsStatus.id='tpSMSStatus';
    smsStatus.textContent='Indlæser SMS-status…'; smsStatus.style.color='#666666'; smsStatus.style.marginBottom='6px';
