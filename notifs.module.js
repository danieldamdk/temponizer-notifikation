...
(function () {
  'use strict';
  const MOD = 'notifs.module';           // ← skift til sms.module / excel.module / caller.module
...
// Funktioner:
//  - Poller Temponizers besked- og interessekilder
//  - OS/DOM-toasts (med cross-tab broadcast) og rate-limit/locks
//  - Pushover (respekterer toggles: tpPushEnableMsg / tpPushEnableInt)
//  - Interesse: navne-hints via popup-HTML + (valgfrit) CSV lookups for afkortede navne
//  - Pending-flush: hvis cooldown forhindrede push, flushes senere
//  - CustomEvents til UI: 'tp:msg-count' og 'tp:int-count' med {count}
...
(function(){
  ...
  const DEF = Object.freeze({
    pushoverToken: '',                  // kræver at brugeren har GM tpUserKey
    pollMs: 15000,                      // standard poll-interval
    suppressMs: 45000,                  // cooldown for at undgå spam
    lockMsExtra: 5000,                  // ekstra margen til locks
    ...
    enableInterestNameHints: true,      // slå popup-navne til/fra
